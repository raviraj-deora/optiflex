...
import 'package:optiflexcalculator/home_screen.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            Image(image: AssetImage("assets/images/phakic-check-type.png"),),
            Container(
              padding: EdgeInsets.only(left: 20,right: 20,top: 10),
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text("OVERVIEW",style: TextStyle(color: AppColors.themeGreyColor,fontSize: 18),),
                  SizedBox(height: 5,),
